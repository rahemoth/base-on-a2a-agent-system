    ...
    if response.status_code == 200:
        ...
        if response.status_code == 200:
            ...
            if "Mock Response" in response_text or "Agent processed your request" in response_text:
                print("\nWARNING: Agent returned mock response. API key may not be working.")
            else:
                print("\nSUCCESS! DeepSeek Agent is working correctly!")
        else:
